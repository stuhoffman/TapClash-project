...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<title>Contact | Apps by STFHS</title>	
		...
		<div id="affero-page">
			<header>
				<div class="affero-header">
					...
					<a href="https://stuhoffman.github.io/TapClash-project/"><img src="../rw_common/images/TapClash-site-logo3.jpg" width="192" height="192" alt="Site logo"/><h1>Apps by STFHS</h1></a>
				</div>
			</header>
			<div class="affero-padding">
					
				<h2 class="affero-slogan">Changing the world, one app at a time&hellip;</h2>
...
<?php unset($_SESSION['form']); ?>
		...
		<div class="affero-footer">
			Theme by 1LD  <a href="#" id="rw_email_contact">Contact Us</a><script type="text/javascript">var _rwObsfuscatedHref0 = "mai";var _rwObsfuscatedHref1 = "lto";var _rwObsfuscatedHref2 = ":in";var _rwObsfuscatedHref3 = "fo@";var _rwObsfuscatedHref4 = "stf";var _rwObsfuscatedHref5 = "hs.";var _rwObsfuscatedHref6 = "net";var _rwObsfuscatedHref = _rwObsfuscatedHref0+_rwObsfuscatedHref1+_rwObsfuscatedHref2+_rwObsfuscatedHref3+_rwObsfuscatedHref4+_rwObsfuscatedHref5+_rwObsfuscatedHref6; document.getElementById("rw_email_contact").href = _rwObsfuscatedHref;</script>
		</div>	
		<nav id="affero-menu">
			<div>
